...
لهذا الإحباط صنعت **Panel 016**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **اختزال ما يحدث حقاً في الصورة إلى مرساة واحدة ومجال واحد للحركة**.
