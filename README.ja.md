...
016 は、モード、サイズ、コピー、多言語化、壁紙、検証の骨格を [XXD Panel 019](https://github.com/nevertoday/xxd-panel-019) と共有しますが、視覚知識は共有しません。

| 016 | 019 |
| --- | --- |
| 小さな核＋ひとつの運動場 | 判別できる被写体＋幾何学的階層 |
| 2–3 色のリソグラフ／シルクスクリーン | 3–5 色のレトロモダニズム平面イラスト |
| 大きな余白と物理的な粒子 | 正負形、スケール差、硬質な色面 |
...
多言語ナビゲーションと README の情報設計は、[Gathered Scenes Zine](https://github.com/Zeejay0/gathered-scenes-zine-skill)、[Photo Abstract Editorial](https://github.com/ZzzLc0405/photo-abstract-editorial)、[Awesome GPT Image 2](https://github.com/freestylefly/awesome-gpt-image-2) を参考にしています。016 の視覚システム、モード、実行ルールは独立しています。
